...
|---|---|---|---|---|
| US1 | Issues [#7](https://github.com/S13863709935/CP3407/issues/7), [#8](https://github.com/S13863709935/CP3407/issues/8), and [#9](https://github.com/S13863709935/CP3407/issues/9) | `/register`, `/login`, token interceptor, Vue login/register views | Registration/login/password and JWT interceptor tests | Implemented; browser acceptance remains |
| US2 | Issues [#10](https://github.com/S13863709935/CP3407/issues/10), [#11](https://github.com/S13863709935/CP3407/issues/11), and [#12](https://github.com/S13863709935/CP3407/issues/12) | Goods create/update APIs, file upload, AddGoods view | Controller/service tests and ownership policy tests | Implemented; strengthen upload validation |
...
| US5 | Issue [#14](https://github.com/S13863709935/CP3407/issues/14) | GoodsDetail, comment tree, and chat group features | Comment tree/deletion and authenticated conversation tests | Implemented; browser acceptance remains |
...
| US7 | Issues [#2](https://github.com/S13863709935/CP3407/issues/2) and [#37](https://github.com/S13863709935/CP3407/issues/37) | Seller Goods view, user-filtered listing service and server-side ownership enforcement | Red-green update/delete, atomic batch and administrator tests | Implemented; repeat crafted requests against deployed API |
| US8 | Issue [#16](https://github.com/S13863709935/CP3407/issues/16) | GoodsDetail order creation, buyer/seller order views, order status workflow, and payment entry point | Trusted order creation, resident/admin scoping, empty-page and sales aggregation tests | Implemented; role-authorised lifecycle and payment sandbox remain |
| US9 | Issue [#4](https://github.com/S13863709935/CP3407/issues/4) | Person view supports avatar and profile updates | Profile update and password validation tests | Implemented; avatar upload persistence remains |
| US10 | Issues [#5](https://github.com/S13863709935/CP3407/issues/5) and [#19](https://github.com/S13863709935/CP3407/issues/19) | Collect API, favourites page, and favourite toggle | Authenticated add/remove, duplicate, resident scope and batch tests | Implemented; browser acceptance remains |
| US11 | Issue [#20](https://github.com/S13863709935/CP3407/issues/20) | Notice API, administrator notice management, and resident Notice view | Author/date, empty page, query, update and deletion tests | Implemented; browser acceptance remains |
| US12 | Issue [#21](https://github.com/S13863709935/CP3407/issues/21) | Feedback submission, user-specific feedback history, administrator management, and reply field | Owner replacement, resident/admin read scope, reply update and deletion tests | Implemented; cross-user mutation hardening remains |
