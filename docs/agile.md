...
| [#24](https://github.com/S13863709935/CP3407/issues/24) | Automated tests | 30 backend tests and two frontend suites pass |
...
- Backend clean verification: passed, 30/30 tests.
